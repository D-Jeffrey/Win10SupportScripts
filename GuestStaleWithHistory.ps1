...
Write-Output ("Guests active since last run     : " + $ActiveGuest.count)
Write-Output ("Guests active in last 28 days    : " + $Act30)
Write-Output ("Pending older than $AcceptInvite days       : " + $PendingAcceptGuests.count)
